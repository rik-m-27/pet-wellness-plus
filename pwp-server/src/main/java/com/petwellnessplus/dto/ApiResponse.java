...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> getResponse(HttpStatus status, T data) {
        return new ApiResponse<>(status.value(), status.getReasonPhrase(), data);
    }
    
    public static <T> ApiResponse<T> informational(HttpStatus status, T data) {
    ...
    public static <T> ApiResponse<T> redirection(HttpStatus status, T data) {
